...
$users_db = [];
#$users_db->[1] = {userid => "testuser", userid_formatted => "TestUser", password => "testpass", email => "", gender => 'F', prefer_censor => 'N'};
#$users_db->[2] = {userid => "anotheruser", userid_formatted => "AnotherUser", password => "testpass2", email => "", gender => 'M', prefer_censor => 'Y'};
